class Game {
  ...
  async start(){
    ...
    car1 = createSprite(100,displayHeight/4+200);
    car1.addAnimation("car1",sol_img);

    car2 = createSprite(150,displayHeight/2);
    car2.addAnimation("car2",sol_img);
  ...
  play(){
    ...
    if (keyIsDown(RIGHT_ARROW) && player.index !== null){
      car1.addAnimation("car1",sol_img);
      car1.changeAnimation("car1",sol_img);
         car1.x = car1.x + 10
         car1.velocityX += 5 
 ...
 //car1.addImage("car3", sol_stand);
      if (keyIsDown(LEFT_ARROW) && player.index !== null){
         ...
         car1.changeAnimation("car0",sol2_img);
         car1.x = car1.x - 10
         car1.velocityX -= 5
